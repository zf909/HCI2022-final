...
class myMainWindow(Ui_Form, QMainWindow):
    ...
    def like(self, event):
        ...
        # self.gestureThread.cancel()

        reply=QMessageBox.information(self, "提示", "收到您的喜欢，请重复确认！感谢您对本视频的喜欢！", QMessageBox.Yes| QMessageBox.No, QMessageBox.Yes)
    ...
    def dislike(self, event):
        ...
        self.gestureThread.pause()
        #self.gestureThread.cancel()
        reply =QMessageBox.information(self, "提示", "收到您的不喜欢，请重复确认！我们将努力提供更让您喜欢的内容！", QMessageBox.Yes|QMessageBox.No, QMessageBox.Yes)
        #self.gestureThread.sleep(10)
        #self.gestureThread.pause()
